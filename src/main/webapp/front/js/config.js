...
var centerMenu = [
    ...
    ,{
        name: '摄影师收藏',
        url: '../sheyingshiCollection/list.jsp'
    }
    ,{
        name: '摄影师订单',
        url: '../sheyingshiOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '摄影师',
        url: './pages/sheyingshi/list.jsp'
    },
    {
        name: '照片库',
        url: './pages/zhaopianku/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/yuepaiwangzhan/index.jsp";
