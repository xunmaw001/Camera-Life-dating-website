              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">照片名字:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhaopiankuName" id="zhaopiankuName"  placeholder="照片名字"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">照片类型:</span>
                        <div class="layui-input-inline">
                            <select name="zhaopiankuTypes" id="zhaopiankuTypes" lay-filter="zhaopiankuTypes" style="width: 600px;">
