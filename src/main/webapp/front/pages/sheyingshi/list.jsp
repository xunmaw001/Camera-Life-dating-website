            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">摄影师展示</span>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../sheyingshi/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../sheyingshi/detail.jsp?id='+item.id)"><span>{{item.sheyingshiName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        // 当前表字典表数据
            sexTypesList : [],
            fenggeTypesList : [],
            sheyingshiXingjiTypesList : [],
            sheyingshiTypes: 1,//类型
            limit: 10,
        ...
        filters: {
            //把 sheyingshiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            sheyingshiContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (sheyingshiXingjiTypes != null && sheyingshiXingjiTypes != "" && sheyingshiXingjiTypes != "null") {
                param['sheyingshiXingjiTypes'] = sheyingshiXingjiTypes;
                                    ...
                                    // 获取列表数据
            http.request('sheyingshi/list', 'get', param, function(res) {
