            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">摄影师名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="sheyingshiName" id="sheyingshiName"  placeholder="摄影师名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">摄影师手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="sheyingshiPhone" id="sheyingshiPhone"  lay-verify="phone|required"   placeholder="摄影师手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">摄影师身份证号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="sheyingshiIdNumber" id="sheyingshiIdNumber"  lay-verify="identity|required"   placeholder="摄影师身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">风格:</span>
                        <div class="layui-input-inline">
                            <select name="fenggeTypes" id="fenggeTypes" lay-filter="fenggeTypes" style="width: 600px;">
                ...
                <%--<div class="layui-form-item layui-form-text input">--%>
                    <%--<div class="layui-inline" >--%>
                        <%--<span style="margin-top: 8px;float: left">星级:</span>--%>
                        <%--<div class="layui-input-inline">--%>
                            <%--<select name="sheyingshiXingjiTypes" id="sheyingshiXingjiTypes" lay-filter="sheyingshiXingjiTypes" style="width: 600px;">--%>
